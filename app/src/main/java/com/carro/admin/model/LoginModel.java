...
public class LoginModel {
    ...
    @SerializedName("m_admin_branch")
    @Expose
    private String mAdminBranch;
    ...
    public String getmAdminBranch() {
        return mAdminBranch;
    }

    public void setmAdminBranch(String mAdminBranch) {
        this.mAdminBranch = mAdminBranch;
    }
